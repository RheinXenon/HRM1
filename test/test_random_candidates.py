...
def run_random_test(num_candidates: int = 10, seed: int = None):
    """
    运行随机候选人测试
    ...
    """
    print("\n" + "="*100)
    print(f"🎲 随机候选人测试 V2.0 - 测试{num_candidates}个候选人")
    print("="*100)
    ...
    # 保存详细结果
    output_file = Path("data/analysis/random_test_results.json")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="随机候选人测试")
    ...
    try:
        analyzer, stats = run_random_test(
