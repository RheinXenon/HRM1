...
def main():
    # 标题
    st.markdown('<h1 class="main-header">🎯 HR 智能面试系统 M1A7</h1>', unsafe_allow_html=True)
    ...
    <div style="text-align: center; color: #94a3b8; padding: 2rem 0;">
        <p>HR 智能面试系统 M1A7 | 基于大语言模型的智能面试解决方案</p>
        <p>支持的领域：技术 | 营销 | 医疗 | ...</p>
    </div>
    """, unsafe_allow_html=True)
